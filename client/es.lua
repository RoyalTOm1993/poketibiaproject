...
locale = {
  ...
  translation = {
    ...
    ["1d) Name Inciting Rule Violation"] = "1d) Nombre que incita una violaciùn al reglamento",
    ["2a) Offensive Statement"] = "2a) Comentario ofensivo",
    ["2b) Spamming"] = "2b) Spamming",
    ["2c) Illegal Advertising"] = "2c) Publicidad ilùcita",
    ["2d) Off-Topic Public Statement"] = "2d) Publicaciùn fuera de lugar",
    ["2e) Non-English Public Statement"] = "2e) Publicaciùn fuera del ingles",
    ["2f) Inciting Rule Violation"] = "2f) Incitar a una violaciùn al reglamento",
    ...
    ["3e) Multi-Clienting"] = "3e) Uso de mùltiples clientes",
    ...
    ["Action:"] = "Acciùn:",
    ["Add"] = "Aùadir",
    ["Add new VIP"] = "Aùadir nuevo VIP",
    ["Addon 1"] = "Addon 1",
    ["Addon 2"] = "Addon 2",
    ["Addon 3"] = "Addon 3",
    ["Add to VIP list"] = "Aùadir a lista VIP",
    ["Adjust volume"] = "Ajustar volumen",
    ["Alas! Brave adventurer, you have met a sad fate.\nBut do not despair, for the gods will bring you back\ninto this world in exchange for a small sacrifice\n\nSimply click on Ok to resume your journeys!"] = "ùAy! Aventurero valiente, has conocido un triste destino. \nPero no se desespere, porque los dioses te llevarùn de vuelta \na este mundo a cambio de un pequeùo sacrificio \n\nSimplemente haga clic en Aceptar para continuar con sus viajes!",
    ["All"] = "Todo",
    ["All modules and scripts were reloaded."] = "Todos los mùdulos y scripts se vuelven a cargar.",
    ["Allow auto chase override"] = "Permitur auto persecuciùn override",
    ...
    ["Amount"] = "Cantidad",
    ["Anonymous"] = "Anùnimo",
    ["Are you sure you want to logout?"] = "ùEstas seguro de que deseas salir?",
    ["Attack"] = "Atacar",
    ["Author"] = "Autor",
    ["Autoload"] = "Auto carga",
    ...
    ["Button Assign"] = "Botùn asignado",
    ["Buy"] = "Compra",
    ["Buy Now"] = "Compra ahora",
    ["Buy Offers"] = "Comprar oferta",
    ["Buy with backpack"] = "Comprar con mochila",
    ["Cancel"] = "Cancelar",
    ["Cannot login while already in game."] = "No se puede iniciar sesiùn, mientras que estùs en el juego.",
    ["Cap"] = "Cap",
    ["Capacity"] = "Capacidad",
    ["Center"] = "Centrar",
    ["Channels"] = "Canales",
    ["Character List"] = "Lista de carùcter",
    ["Classic control"] = "Controles Clùsicos",
    ["Clear current message window"] = "Limpiar mensaje actual en ventana",
    ["Clear Messages"] = "Limpiar mensaje",
    ["Clear object"] = "Limpiar objeto",
    ["Client needs update."] = "El cliente necesita una actualizaciùn.",
    ["Close"] = "Cerrar",
    ...
    ["Dismount"] = "Desmontar",
    ["Display connection speed to the server (milliseconds)"] = "Mostrar velocidad de conexiùn en el servidor (millisegundos)",
    ["Distance Fighting"] = "Combate a distancia",
    ["Don\'t stretch/shrink Game Window"] = "No estirar ni reducir el tamaùo de ventana",
    ["Edit hotkey text:"] = "Editar texto de hotkey:",
    ["Edit List"] = "Editar lista",
    ["Edit Text"] = "Editar texto",
    ["Enable music"] = "Habilitar mùsica",
    ["Enable Shared Experience"] = "Habilitar experiencia compartida",
    ["Enable smart walking"] = "Habilitar caminado inteligente",
    ["Enable vertical synchronization"] = "Habilitar sincronizaciùn vertical",
    ...
    ["Filter list to match your vocation"] = "Lista de filtros que coincida con el vocaciùn",
    ["Find:"] = "Encontrar:",
    ["Fishing"] = "Pesca",
    ["Fist Fighting"] = "Combate con puùos",
    ["Follow"] = "Seguir",
    ["Force Exit"] = "Forzar salida",
    ["For Your Information"] = "Para tu informaciùn",
    ["Free Account"] = "Cuenta gratis",
    ["Fullscreen"] = "Pantalla completa",
    ["Game"] = "Juego",
    ["Game framerate limit: %s"] = "Limite de cuadros por segundo en el juego: %s",
    ["Graphics"] = "Grùficos",
    ["Graphics card driver not detected"] = "Controlador de tarjeta grùfica de video no detectado",
    ["Graphics Engine:"] = "Motor Grùfico:",
    ["Head"] = "Cabeza",
    ["Healing"] = "Curaciùn",
    ["Health Info"] = "HP Info",--This can be better
    ["Health Information"] = "HP Informaciùn",--This can be better
    ...
    ["Hide spells for other vocations"] = "Ocultar hechizos que sean para otra vocaciùn",
    ["Hit Points"] = "Puntos de vida",
    ["Hold left mouse button to navigate\nScroll mouse middle button to zoom\nRight mouse button to create map marks"] = "Mantenga presionado el botùn derecho del ratùn para navegar\nDezplaze la rueda central del ratùn para ampliar\nbotùn derecho del mouse para crear marcas del mapa",
    ["Hotkeys"] = "Hotkeys",
    ...
    ["IP Address Banishment"] = "Banishment - Direcciùn IP",
    ["Item Offers"] = "Ofertas de objetos",
    ["It is empty."] = "Estù vaciù.",
    ...
    ["Load"] = "Cargar",
    ["Logging out..."] = "Cerrando sesiùn...",
    ["Login"] = "Ingresar",
    ["Login Error"] = "Error de ingreso",
    ["Login Error"] = "Error de ingreso",
    ["Logout"] = "Salir",
    ["Look"] = "Mirar",
    ["Magic Level"] = "Nivel mùgico",
    ["Make sure that your client uses\nthe correct game protocol version"] = "Asegùrese de que el cliente este utilizando\nes el versiùn del protocolo adecuado",
    ["Mana"] = "Mana",
    ["Manage hotkeys:"] = "Administrador de hotkeys:",
    ["Market"] = "Mercado",
    ["Market Offers"] = "Ofertas en mercado",
    ["Message of the day"] = "Mensaje del dùa",
    ["Message to "] = "Mensaje a",
    ["Message to %s"] = "Mensaje a %s",
    ["Minimap"] = "Minimapa",
    ["Module Manager"] = "Administrador de mùdulos",
    ...
    ["No"] = "No",
    ["No graphics card detected, everything will be drawn using the CPU,\nthus the performance will be really bad.\nPlease update your graphics driver to have a better performance."] = "No se ha detectado una tarjeta grùfica y todo sera procesado por tu procesador,\npor lo tanto el rendimiento va a ser muy malo.\nPor favor, actualice su controlador de grùficos para tener un rendimiento optimo.",
    ...
    ["Open charlist automatically when starting client"] = "Abrir lista de jugadores automùticamente al iniciar el cliente",
    ["Open in new window"] = "Abrir en nueva ventana",
    ["Open new channel"] = "Abrir nuevo canal",
    ["Options"] = "Opciones",
    ["Overview"] = "Descripciùn",
    ...
    ["Please use this dialog to only report bugs. Do not report rule violations here!"] = "Por favor usa este diùlogo solo para reportar errores.\nùNo reportar violaciones del reglamento aquù!",
    ["Please wait"] = "Por favor espere",
    ["Port"] = "Puerto",
    ["Position:"] = "Posiciùn:",
    ["Position: %i %i %i"] = "Posiciùn: %i %i %i",
    ["Premium Account (%s) days left"] = "Tienes (%s) dùas de Premium Account restantes",
    ["Price:"] = "Precio:",
    ["Primary"] = "Primario",
    ["Protocol"] = "Protocolo",
    ...
    ["Regeneration Time"] = "Tiempo de regeneraciùn",
    ["Reject"] = "Rechazar",
    ["Reload All"] = "Cargar todo de nuevo",
    ["Remember account and password when starts client"] = "Recordar cuenta y contraseùa al iniciar el cliente",
    ["Remember password"] = "Recordar contraseùa",
    ["Remove"] = "Remover",
    ["Remove %s"] = "Remover %s",
    ["Report Bug"] = "Reportar error",
    ["Reserved for more functionality later."] = "Reservado para una funciùn futura.",
    ["Reset Market"] = "Reiniciar mercado",
    ["Revoke %s\'s Invitation"] = "Anular %s\'s invitaciùn",
    ["Rotate"] = "Rotar",
    ["Rule Violation"] = "Violaciùn del reglamento",
    ["Save"] = "Guardar",
    ...
    ["Send"] = "Enviar",
    ["Send automatically"] = "Enviar automùticamente",
    ...
    ["Show connection ping"] = "Mostrar ping de conexiùn",
    ["Show Depot Only"] = "Mostrar solo el Depot",
    ["Show event messages in console"] = "Mostrar mensajes de evento en consola",
    ["Show frame rate"] = "Mostrar informaciùn de cuadros por secundo",
    ["Show info messages in console"] = "Mostrar mensajes de informaciùn en consola",
    ...
    ["Skills"] = "Habilidades",
    ["Soul"] = "Soul",
    ["Soul Points"] = "Puntos de Soul", --I'm leaving these as is because its a unique name, if you want to change it it can be "Alma" or "Espùritu"
    ["Special"] = "Especial",
    ["Speed"] = "Velocidad",
    ...
    ["Statistics"] = "Estadùsticas",
    ["Stop Attack"] = "Detener ataque",
    ["Stop Follow"] = "Detener persecuciùn",
    ["Support"] = "Soporte",
    ...
    ["Unable to load dat file, please place a valid dat in '%s'"] = "No se puede cargar el archivo dat, por favor coloque un dat vùlido en '%s'",
    ["Unable to load spr file, please place a valid spr in '%s'"] = "No se puede cargar el archivo spr, por favor coloque un spr vùlido en '%s'",
    ["Unable to logout."] = "No se puede cerrar sesiùn-",
    ...
    ["You are hasted"] = "Tu estas rùpido", --I dont know what is the best way to translate this so I'm leaving it as I found it.
    ["You are hungry"] = "Tu estas hambriento",
    ["You are paralysed"] = "Tu estas paralizado",
    ["You are poisoned"] = "Tu estas envenedado",
    ["You are protected by a magic shield"] = "Tu estas protegido por un escudo mùgico",
    ["You are strengthened"] = "Tu estas reforzado",
    ["You are within a protection zone"] = "Tu estas dentro de una zona de protecciùn",
    ...
    ["You may not logout or enter a protection zone"] = "No puedes salir o entrar en una zona de protecciùn",
    ["You must enter a comment."] = "Debes ingresar un comentario.",
    ["You must enter a valid server address and port."] = "Debes ingresar una direcciùn vùlida de servidor y el puerto.",
    ["You must select a character to login!"] = "ùDebes seleccionar un personaje para ingresar!",
