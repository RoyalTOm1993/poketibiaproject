locale = {
  ...
  translation = {
    ...
    ["Attack"] = "Atacar",
    ["Audio"] = "Áudio",
    ["This trainer is offline."] = "Esse treinador está offline.",
    ["Author"] = "Autor",
    ...
    ["Battle"] = "Batalha",
    ["Welcome to PokéMaster Online!"] = "Bem vindo(a) ao PokéMaster Online!",
    ["Browse"] = "Navegar",
    ...
    ["Detail"] = "Detalhe",
    ["Details"] = "Detalhes",
    ["Write here..."] = "Digite aqui...",
    ["Disable chat mode, allow to walk using WASD."] = "Desativar o chat, permite andar usando WASD.",
    ...
    ["Enable chat mode"] = "Ativar o chat",
    ["Enable combat controls"] = "Ativar controles de combate",
    ["Enable crosshair"] = "Ativar mira",
    ["Enable dash walking (recommended for high speed characters)"] = "Ativar andar rápido (recomendado para personagens com alta velocidade)",
    ["Enable diagonal step detection"] = "Ativar detecção de passo diagonal",
    ["Enable FPS limit"] = "Ativar limite de FPS",
    ["Enable game framerate limit"] = "Ativar limite da taxa de quadros do jogo",
    ["Enable graphics card driver detection"] = "Ativar detecção do driver da placa de vídeo",
    ...
    ["Login"] = "Entrar",
    ["LOGOUT"] = "SAIR",
    ["Lock chat"] = "Travar chat",
    ["Unlock chat"] = "Destravar chat",
    ["Look"] = "Olhar",
