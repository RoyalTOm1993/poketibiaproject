...
locale = {
  ...
  translation = {
    ...
    ["Action:"] = false,
    ["Add"] = "Hinzufùgen",
    ["Add new VIP"] = "Neuen Freund hinzufùgen",
    ["Addon 1"] = "Addon 1",
    ["Addon 2"] = "Addon 2",
    ["Addon 3"] = "Addon 3",
    ["Add to VIP list"] = "Zur VIP Liste hinzufùgen",
    ["Adjust volume"] = "Lautstùrke regeln",
    ...
    ["Autoload priority"] = "Ladeprioritùt",
    ["Auto login"] = "Automatisch einloggen",
    ["Auto login selected character on next charlist load"] = "Automatisches einloggen des ausgewùhlten Charakters",
    ...
    ["Battle"] = "Kampf",
    ["Browse"] = false,
    ["Bug report sent."] = "Bugreport wùrde versendet.",
    ...
    ["Cancel"] = "Abbrechen",
    ["Cannot login while already in game."] = "Sie kùnnen sich nicht einloggen wùhrend Sie im Spiel sind.",
    ["Cap"] = false,
    ...
    ["Close"] = "Schlieùen",
    ["Close this channel"] = "Diesen Channel schlieùen",
    ...
    ["Current hotkey to add: %s"] = "Hotkeys zum hinzufùgen: %s",
    ...
    ["Exclude from private chat"] = "Aus dem Privatgesprùch ausschlieùen",
    ["Exit"] = false,
    ...
    ["Hotkeys"] = false,
    ["If you shut down the program, your character might stay in the game.\nClick on 'Logout' to ensure that you character leaves the game properly.\nClick on 'Exit' if you want to exit the program without logging out your character."] = "Wenn du das Programm schlieùt kann es sein, dass dein Charakter im Spiel verweilt.nKlicke 'Logout' um sicherzustellen, dass dein Charakter das Spiel wirklich verlùsst.\nKlicke 'Exit' wenn du das Programm beenden willst on deinen Charakter auszuloggen.",
    ["Ignore"] = false,
    ...
    ["No item selected."] = "Keine Items ausgewùhlt",
    ...
    ["on %s.\n"] = false,
    ["Open"] = "ùffnen",
    ["Open a private message channel:"] = "Privatchannel ùffnen:",
    ["Open charlist automatically when starting client"] = false,
    ["Open in new window"] = "Im neuen Fenster ùffnen",
    ["Open new channel"] = "Neuen Channel ùffnen",
    ["Options"] = "Optionen",
    ["Overview"] = false,
    ["Pass Leadership to %s"] = "%s zum Anfùhrer ernennen",
    ["Password"] = "Passwort",
    ["Piece Price:"] = "Stùckpreis",
    ["Please enter a character name:"] = "Bitte gib einen Charakternamen an:",
    ["Please, press the key you wish to add onto your hotkeys manager"] = "Bitte die gewùnschte Taste drùcken",
    ["Please Select"] = false,
    ...
    ["Quest Log"] = false,
    ["Randomize"] = false,
    ["Randomize characters outfit"] = "Zufùlliges Outfit",
    ["Reason:"] = "Grund:",
    ...
    ["Reset Market"] = false,
    ["Revoke %s's Invitation"] = "%ss Einladung zurùckziehen",
    ["Rotate"] = "Rotieren",
    ...
    ["Secondary"] = "Sekundùr",
    ["Select object"] = "Objekt auswùhlen",
    ["Select Outfit"] = "Outfit auswùhlen",
    ...
    ["Unable to logout."] = "Es ist nicht mùglich auszuloggen.",
    ["Unignore"] = false,
    ["Unload"] = false,
    ["Update needed"] = false,
    ["Use"] = "Benutzen",
    ...
    ["You are protected by a magic shield"] = "Du wirst von einem magischen Schild beschùtzt",
    ["You are strengthened"] = "Du bist gestùrkt",
    ...
    ["You must enter a valid server address and port."] = "Du musst eine gùltige Serveradresse und einen gùltigen Port eingeben",
    ["You must select a character to login!"] = "Du musst einen Charakter auswùhlen!",
