...
function create()
  ...
  windowButton = modules.client_topmenu.addRightGameToggleButton("guildManagement", tr("Guild Management"), "images/topbuttons/guild.png", toggle, false, 9)
  window:hide()
...
function onGuildRanksData(data)
  ...
  for _, rank in ipairs(data) do
    local row = ranksPanel.ranksTable:addRow(
      {
...
function onPacifismStatus(data)
  ...
  local pacifismDate = getPacifismDate()
