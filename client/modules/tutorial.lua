...
function init()    
    ...
    tutorialButton = modules.client_topmenu.addLeftGameButton(tutorialWindowID, tr('Guia de Ajuda'), '/images/topbuttons/tutorial.png', onClickTutorial, false, true)
...
function onCLickBackButton()
    ...
    form.assignWindow:setImageSource("/images/game/Module/tutorial/painelinicio")
end
