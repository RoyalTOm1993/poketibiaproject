...
function init()  
  ...
  battleButton = modules.client_topmenu.addLeftGameButton('battleButton', tr('Battle') .. ' (Ctrl+B)', '/images/topbuttons/battle', toggle, false, 2)
...
function checkCreatures()
  ...
  local spectators = g_map.getSpectatorsInRangeEx(player:getPosition(), false, math.floor(dimension.width / 3), math.floor(dimension.width / 3), math.floor(dimension.height / 3), math.floor(dimension.height / 3))
