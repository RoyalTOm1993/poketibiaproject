...
function init()
  ...
  TopToggleButtonNew.onClick = toggle
...
function toggle()
  ...
  if topMenu:isVisible() then
    addEvent(function() g_effects.fadeOut(topMenu, 700) end)
    scheduleEvent(hide, 700)
  else
    addEvent(function() g_effects.fadeIn(topMenu, 700) end)
    show()
  end
end
