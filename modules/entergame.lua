...
function EnterGame.init()
  ...
  showPasswordBox = enterGame:getChildById('showPassword')
  ...
  showPasswordBox:setChecked(true)
...
function getPassword()
	return enterGame:getChildById('accountPasswordTextEdit')
end

function getAccount()
	return enterGame:getChildById('accountNameTextEdit')
end

function getPasswordText()
	return enterGame:getChildById('showPasswordText')
end
...
function EnterGame.show()
  if not enterGame then return end
   -- addEvent(function() g_effects.fadeIn(enterGame, 1500) end)
  enterGame:show()
  enterGame:raise()
  enterGame:focus()
