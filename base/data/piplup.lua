...
local mType = Game.createMonsterType("Piplup")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Piplup"
...
pokemon.moves = {
    ...
    {name = "Doubleslap", power = 10, interval = 15000},
...
pokemon.attacks = {
    ...
    {name = "Doubleslap", power = 10, interval = 15000, chance = 100},
