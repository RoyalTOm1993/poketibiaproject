function onUse(cid, item, frompos, item2, topos)
    ...
    if antes == -1 then
        Game.broadcastMessage("O jogador " .. player:getName() .. " está tentando fazer a quest Tyer5 mas não deveria estar aqui!", MESSAGE_STATUS_WARNING)
    ...
    if item:getUniqueId() == 11091 then
        ...
        if queststatus == -1 then
            player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "Você completou Tyer 5.!.")
