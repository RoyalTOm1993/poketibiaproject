...
local pokemon = "Perfect Zoroark"
local storage = 53410 -- storage
...
function onUse(cid, item, frompos, item2, topos)
    ...
    local chance = math.random(1, 1) -- Gerar um número aleatório entre 1 e 4
    ...
    if chance == 1 then
        ...
        if pokeball then
            ...
            local message = playerName .. " pegou um " .. pokemon .. " na quest Perfect Zoroark!"
