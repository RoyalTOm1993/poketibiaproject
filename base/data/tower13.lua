local t = {
storage = 3598, -- Soh mexa se necessario.
temp = 6, -- Tempo em horas.
count = 2, -- quantidade da reward que sera ganha
reward = 13565 -- Item que irá ganhar. -- por ser o ultimo item do array nao necessita virgula
}
