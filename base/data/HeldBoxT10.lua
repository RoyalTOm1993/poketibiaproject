...
function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "Voce abriu uma held box t10 e ganhou "..items[a].count.."x "..(tonumber(items[a].id) and getItemNameById(items[a].id) or "level"..(items[a].count > 1 and "s" or ""))..".")
