function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    local availableItems = {
        ...
        {itemId = 13565, minAmount = 1, maxAmount = 1},
        {itemId = 20679, minAmount = 1, maxAmount = 1},
        {itemId = 20709, minAmount = 3, maxAmount = 1},
        {itemId = 20708, minAmount = 3, maxAmount = 1},
        {itemId = 17315, minAmount = 1, maxAmount = 1},
        {itemId = 20652, minAmount = 1, maxAmount = 5},
        {itemId = 22664, minAmount = 3, maxAmount = 1},
        {itemId = 17208, minAmount = 1, maxAmount = 1},
        {itemId = 17120, minAmount = 1, maxAmount = 1},
        {itemId = 13228, minAmount = 3, maxAmount = 1},
        {itemId = 23035, minAmount = 3, maxAmount = 1},
        {itemId = 23036, minAmount = 3, maxAmount = 1},
        {itemId = 2145, minAmount = 3, maxAmount = 1},
    }

    local numItemsToAdd = math.random(1, 7)
    local chosenItems = {}
    ...
    if not foundItems then
        ...
        Game.broadcastMessage(player:getName() .. " acabou de abrir uma bolsa cheia de itens aleatórios!", MESSAGE_EVENT_ADVANCE)
    end
