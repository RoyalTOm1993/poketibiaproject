...
local mType = Game.createMonsterType("Spearow")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Spearow"
...
pokemon.moves = {
    ...
    {name = "Agility", power = 0, interval = 25000},
}
...
pokemon.attacks = {
    ...
    {name = "Agility", power = 0, interval = 25000, chance = 100},
}
