...
function onUse(player, item, fromPosition, target, toPosition, isHotkey)
    if item:getId() == 16232 and (target:getId() == 4821 or target:getId() == 4822 or target:getId() == 4823 or target:getId() == 4824 or target:getId() == 4825 or target:getId() == 4820) then
        ...
        local numFishToCatch = math.random(1, 3)
        local caughtFish = {}
