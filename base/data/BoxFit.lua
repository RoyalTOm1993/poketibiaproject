function onUse(cid, item, frompos, item2, topos)
    ...
    local hasBoughtOutfit = player:getStorageValue(201061) == 1
    ...
    if playerItem >= requiredItemAmount then
        ...
        player:setStorageValue(201061, 1) -- Define a storage para indicar que o jogador comprou a outfit
    else
