function onStepIn(cid, item, position, fromPosition)
  ...
  local requiredStorageValue = 40 -- Valor mínimo da storage
  local maxStorageValue = 79 -- Valor máximo da storage
  ...
  local teleportPosition = {x = 3999, y = 3044, z = 7} -- Replace with the desired teleport position
