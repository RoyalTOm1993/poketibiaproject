...
local storage = 2231 -- storage
local posteleporte = {x = 3099, y = 2906, z = 6}

local megaPokemons = {"Ice Entei", "Ice Heatran", "Ice Kyurem", "Ice Jirachi", "Ice Victini"}
...
function onUse(cid, item, frompos, item2, topos)
    ...
    if player:getStorageValue(storage) <= 0 then
        ...
        if pokeball then
            player:sendTextMessage(MESSAGE_INFO_DESCR, "Parabéns! Você completou a quest e recebeu o Pokémon " .. selectedPokemon .. "!")
