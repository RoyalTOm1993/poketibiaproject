...
local mType = Game.createMonsterType("Dewgong")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Icy Wind", power = 7, interval = 25000},
    {name = "Aurora Beam", power = 7, interval = 45000},
    {name = "Blizzard", power = 25, interval = 80000},
...
pokemon.attacks = {
    ...
    {name = "Icy Wind", power = 7, interval = 25000, chance = 100},
    {name = "Aurora Beam", power = 7, interval = 45000, chance = 100},
    {name = "Blizzard", power = 25, interval = 80000, chance = 100},
