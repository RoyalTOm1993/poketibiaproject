local lootTable = {
    ...
    [16186] = 1, -- ItemID 5678 com quantidade 3
    [22665] = 2, -- ItemID 5678 com quantidade 3

    -- Adicione mais itens conforme necessário
}

local requiredStorage = 1001
local rewardedStorage = 1002
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    if player:getStorageValue(requiredStorage) ~= 1 then
        ...
        broadcastMessage("O jogador " .. player:getName() .. " tentou concluir a quest Box 6, mas ainda não completou a box 5!")
