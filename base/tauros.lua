...
local mType = Game.createMonsterType("Tauros")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Tauros"
...
pokemon.moves = {
    ...
    {name = "Thrash", power = 15, interval = 30000},
...
pokemon.attacks = {
    ...
    {name = "Thrash", power = 15, interval = 30000, chance = 100},
