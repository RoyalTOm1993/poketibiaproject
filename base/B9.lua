local lootTable = {
    ...
    [16189] = 1, -- ItemID 5678 com quantidade 3
    [22665] = 2, -- ItemID 5678 com quantidade 3

    -- Adicione mais itens conforme necessário
}

local requiredStorage = 1004
local rewardedStorage = 1005
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    if player:getStorageValue(requiredStorage) ~= 1 then
        ...
        broadcastMessage("O jogador " .. player:getName() .. " tentou concluir a quest Box 9, mas ainda não completou a box 8!")
