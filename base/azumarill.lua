...
local mType = Game.createMonsterType("Azumarill")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Azumarill"
...
pokemon.moves = {
    ...
    {name = "Whirlpool", power = 15, interval = 50000},
...
pokemon.attacks = {
    ...
    {name = "Whirlpool", power = 15, interval = 50000, chance = 100},
