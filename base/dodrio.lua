...
local mType = Game.createMonsterType("Dodrio")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Dodrio"
...
pokemon.moves = {
    ...
    {name = "Pluck", power = 12, interval = 15000},
    {name = "Tri-Attack", power = 20, interval = 40000},
    {name = "Roost", power = 20, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Pluck", power = 12, interval = 15000, chance = 100},
    {name = "Tri-Attack", power = 20, interval = 40000, chance = 100},
    {name = "Roost", power = 20, interval = 60000, chance = 100},
