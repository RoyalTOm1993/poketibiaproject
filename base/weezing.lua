...
local mType = Game.createMonsterType("Weezing")
local pokemon = {}
pokemon.eventFile = false -- will try to load the file example.lua in data/scripts/pokemons/events
pokemon.eventFile = "default" -- will try to load the file test.lua in data/scripts/pokemons/events
pokemon.description = "a Weezing"
...
pokemon.moves = {
    ...
    {name = "Poison Gas", power = 12, interval = 20000},
    {name = "Mortal Gas", power = 15, interval = 60000},
...
pokemon.attacks = {
    ...
    {name = "Poison Gas", power = 12, interval = 20000, chance = 100},
    {name = "Mortal Gas", power = 15, interval = 60000, chance = 100},
