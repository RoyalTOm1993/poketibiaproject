...
local mType = Game.createMonsterType("Shiny Arcanine")
local pokemon = {}
pokemon.eventFile = false
pokemon.eventFile = "default" 
pokemon.description = "a Shiny Arcanine"
...
pokemon.flags = {
    ...
    hasShiny = 1,
    hasMega = 0,
    moveMagicAttackBase = 210,
    moveMagicDefenseBase = 170,
    catchChance = 250,
    canControlMind = 0,
    canLevitate = 0,
    canLight = 0,
