local lootTable = {
    ...
    [16210] = 1, -- ItemID 5678 com quantidade 3
    -- Adicione mais itens conforme necessário
}

local requiredStorage = 10025
local rewardedStorage = 10026
...
function onUse(cid, item, fromPosition, itemEx, toPosition)
    ...
    if player:getStorageValue(requiredStorage) ~= 1 then
        ...
        broadcastMessage("O jogador " .. player:getName() .. " tentou concluir a quest Super Box4, mas ainda não completou a Super Box3!")
