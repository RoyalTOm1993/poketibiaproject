...
local mType = Game.createMonsterType("Charmander")
local pokemon = {}
...
pokemon.moves = {
    ...
    {name = "Scratch", power = 7, interval = 12000},
    {name = "Ember", power = 10, interval = 10000},
    {name = "Flamethrower", power = 10, interval = 18000},
    {name = "Fire Ball", power = 10, interval = 22000},
    {name = "Fire Fang", power = 7, interval = 15000},
...
pokemon.attacks = {
    ...
    {name = "Scratch", power = 7, interval = 12000, chance = 100},
    {name = "Ember", power = 10, interval = 10000, chance = 100},
    {name = "Flamethrower", power = 10, interval = 18000, chance = 100},
    {name = "Fire Ball", power = 10, interval = 22000, chance = 100},
    {name = "Fire Fang", power = 7, interval = 15000, chance = 100},
...
mType.onAppear = function(monster, creature)
    if creature and creature:isMonster() then
        creature:setNickname("Charmander")
    end
end
